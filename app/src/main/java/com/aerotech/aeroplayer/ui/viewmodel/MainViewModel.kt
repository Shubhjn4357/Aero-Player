...
import com.aerotech.aeroplayer.data.database.AppDatabase
...
import com.aerotech.aeroplayer.data.repository.HistoryRepository
import com.aerotech.aeroplayer.data.repository.MediaRepository
import com.aerotech.aeroplayer.data.repository.PreferenceRepository
import com.aerotech.aeroplayer.util.downloadFileFromWeb as utilDownloadFileFromWeb
import com.aerotech.aeroplayer.util.setAsRingtone as utilSetAsRingtone
import com.aerotech.aeroplayer.util.shareMediaItems as utilShareMediaItems
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val subtitleEngine = com.aerotech.aeroplayer.player.subtitle.UnifiedSubtitleEngine(viewModelScope)
    ...
    private var _vlcPlayerInstance: com.aerotech.aeroplayer.player.VlcPlayerWrapper? = null
    val vlcPlayer: com.aerotech.aeroplayer.player.VlcPlayerWrapper
        get() {
            if (_vlcPlayerInstance == null) {
                _vlcPlayerInstance = com.aerotech.aeroplayer.player.VlcPlayerWrapper(getApplication())
    ...
    fun loadDemoMediaPack() {
        viewModelScope.launch(Dispatchers.IO) {
            val samples = listOf(
                ...
                MediaEntity(
                    uriString = "https://www.soundhelix.com.aerotech.aeroplayers/mp3/SoundHelix-Song-1.mp3",
                    ...
                    dateAdded = System.currentTimeMillis() / 1000,
                    isVideo = false,
                    path = "https://www.soundhelix.com.aerotech.aeroplayers/mp3/SoundHelix-Song-1.mp3",
                    mimeType = "audio/mpeg",
                    genre = "Electronic"
                ),
                MediaEntity(
                    uriString = "https://www.soundhelix.com.aerotech.aeroplayers/mp3/SoundHelix-Song-2.mp3",
                    ...
                    dateAdded = System.currentTimeMillis() / 1000,
                    isVideo = false,
                    path = "https://www.soundhelix.com.aerotech.aeroplayers/mp3/SoundHelix-Song-2.mp3",
                    mimeType = "audio/mpeg",
                    genre = "Ambient"
                )
            )
