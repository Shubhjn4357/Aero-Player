...
object PlayerWidgetProvider {
    ...
    fun updateAll(context: Context, title: String, artist: String, isPlaying: Boolean, art: Bitmap? = null) {
    ...
    fun update2x2Widgets(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        for (id in appWidgetIds) {
            ...
            views.setImageViewResource(R.id.widget_btn_play_pause_2x2, if (lastIsPlaying) R.drawable.ic_pause else R.drawable.ic_play)
